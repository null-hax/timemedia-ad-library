    ...
    try {
      ...
      if (filters.search) {
        ...
        filteredAds = filteredAds.filter(ad => 
          ...
          ad.newsletters.some(n => n.name.toLowerCase().includes(searchTerm))
        )
      }
